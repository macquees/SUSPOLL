...
if(Honeybee==TRUE){
    ...
    i0_min = i0_resting_min
    i0_max = i0_flying_max
...
for(i in 1:n_samples){ #for each sample
    ...
    Param_values[i,2] = qunif(LHS_sample[i,2],min=i0_min,max=i0_max)
...
if(Honeybee==TRUE){
    write.csv(Param_values,file="ParameterSample_10000_combined_HB_3.csv")
}
...
column_names = c("delta_T_h", "i0", "i0_flying", "M_b", "M_th", "E", "c", "r", "T_mK", "alpha_si", 
