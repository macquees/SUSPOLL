...
%%%  can be modified to produce individual solution curves
%%% by chaniging i = 1:51 to i = x where x is the desired air temp
...
pcolors=['b' 'g' 'r'];  %used if plotting in matlab
...
if Honeybee == true
writematrix(Temps_median,'Flying_Honeybee_LookupTable_Full.csv');
end

if Bumblebee == true
writematrix(Temps_median,'Flying_Bumblebee_LookupTable_Full.csv');
end
